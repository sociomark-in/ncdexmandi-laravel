...
class NewsController extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->admin_dashboard('news/home', $this->data);
    }
    public function new_post()
    {
        ...
        $this->data['categories'] = json_decode($this->CategoriesModel->get(null, ['id', 'name']), true);
        $this->data['tags'] = json_decode($this->TagsModel->get(null, ['id', 'name']), true);
        $this->load->admin_dashboard('news/new', $this->data);
    }
    ...
    public function view_post($post_id)
    {
        ...
        if ($request['post_preview']) {
            $this->load->admin_dashboard('news/preview', $this->data);
        } else {
            redirect();
        }
    }
    ...
    public function edit_post($post_id){
        ...
        $this->load->admin_dashboard('news/edit', $this->data);
    }
